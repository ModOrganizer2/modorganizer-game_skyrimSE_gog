...
bool GameSkyrimSEGOG::init(IOrganizer *moInfo)
{
    ...
    registerFeature<ScriptExtender>(new SkyrimSEGOGScriptExtender(this));
    registerFeature<DataArchives>(new SkyrimSEGOGDataArchives(myGamesPath()));
    registerFeature<LocalSavegames>(new GamebryoLocalSavegames(myGamesPath(), "Skyrimcustom.ini"));
    registerFeature<ModDataChecker>(new SkyrimSEGOGModDataChecker(this));
    registerFeature<ModDataContent>(new SkyrimSEGOGModDataContent(this));
    registerFeature<SaveGameInfo>(new GamebryoSaveGameInfo(this));
    registerFeature<GamePlugins>(new CreationGamePlugins(moInfo));
    registerFeature<UnmanagedMods>(new SkyrimSEGOGUnmangedMods(this));
...
{
    return tr("Adds support for the game Skyrim Special Edition - GOG Edition.");
}
